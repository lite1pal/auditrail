import { jobOutbox } from "@auditrail/db/schema";
import {
  jobNameSchema,
  jobPayloadSchema,
  jobStatusSchema
} from "@auditrail/domain/jobs";
import { and, asc, eq, sql } from "drizzle-orm";

import type {
  CountPendingJobsOptions,
  JobOutboxRepo,
  JobOutboxRecord,
  ListPendingJobsOptions,
...
export function createPostgresJobOutboxRepo(
  ...
  return {
    ...
    async markCompleted(input: MarkJobCompletedInput) {
