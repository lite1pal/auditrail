...
- business rules: `apps/api/src/modules/generated/task/service.ts`
- persistence queries: `apps/api/src/modules/generated/task/postgres-repo.ts`
- request validation and route shaping: `apps/api/src/modules/generated/task/routes.ts`
- UI copy and layout: `apps/web/src/features/task/components/*`
